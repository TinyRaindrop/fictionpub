...
def run_gui():
    ...
    # The GUI libraries are imported here, inside the main function, to keep the CLI lightweight.
    ...
    class ConverterApp:
        def __init__(self, root):
            ...
            # --- FIX: Use more reliable base64 GIF data for checkboxes ---
        ...
        def _populate_file_list(self, paths):
            # ... (logic to find files is unchanged) ...
            files_to_add = []
            for path in paths:
                if path.is_dir():
        ...
        def _process_queue(self):
            try:
                while True:
                    ...
                    elif task_type == "conversion_done":
                        self.status_label.config(text=data)
                        self._update_button_states()
